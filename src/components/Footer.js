...
const Footer = () => {
  ...
  const handleRedirectNiraj = () => {
    window.open('https://www.instagram.com/neeraj.bharadva?utm_source=qr', '_blank');
  };

  const handleRedirectBansi = () => {
    window.open('https://www.instagram.com/vrajesh.gajjar?utm_source=qr', '_blank');
  };
  ...
  return (
    <footer className="bg-dark text-white text-center py-3">
      ...
      <p id="os">
        owned by <span onClick={handleRedirectNiraj} style={{ cursor: 'pointer' }}>Niraj Bharadva</span>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48" onClick={handleRedirectNiraj} style={{ cursor: 'pointer', verticalAlign: 'middle', marginLeft: '5px' }}>
        ...
        && <span onClick={handleRedirectBansi} style={{ cursor: 'pointer' }}>Bansikumar Ujeniya</span>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 48 48" onClick={handleRedirectBansi} style={{ cursor: 'pointer', verticalAlign: 'middle', marginLeft: '5px' }}>
          <radialGradient id="yOrnnhliCrdS2gy~4tD8ma_Xy10Jcu1L2Su_gr1" cx="19.38" cy="42.035" r="44.899" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#fd5" />
            <stop offset=".328" stopColor="#ff543f" />
            <stop offset=".348" stopColor="#fc5245" />
